...
class DatasetBuilder:
  ...
  def create_dataset_of_particular_stage(self, num_segs_chosen_per_patient):      #main
    ...
    for p in range(self.num_patients): 
      ...
      for selected_tuple in segment_tuple_generator:
...
ref_label = 5
dataset = DatasetBuilder(ref_label=ref_label, num_patients=NUM_CHOSEN_PATIENTS)  #num_patients->number of patients from which random segment  will be chosen
